...
const handleBuild = (words) => {
  ...
  if (unitsBuilt[currentPlayer][currentUnit] === undefined) {
    unitsBuilt[currentPlayer][currentUnit] = 0;
  }
  unitsBuilt[currentPlayer][currentUnit] += Number(amount);
